...
# result = ' Hello World '.lstrip()   => soldan siler
# result = ' Hello World '.rstrip()   => sağdan siler

# result = website.lstrip('/:pth')   => soldan bu karekterler silindi
...
# result = website.count("a")         => "a" harfi kaçkere kullanılmış
...
# result = course.isalpha()    => alfabe
# result = 'Hello'.isalpha()  
# result = course.isdigit()    => rakam
# result = '123'.isdigit()
